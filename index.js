...
(function () {
    ...
    //HTML Elements
    var saveTasksBtn = document.getElementById("submit-btn");
    ...
    var cancelModalButton = document.getElementById("cancel-modal-btn");
    //ount Vars
    ...
    var dueDateTask = document.getElementById("task-due-date");
    ...
    function displayTasks(arr) {
        ...
        <div class="group relative rounded-2xl border border-slate-100 bg-white p-5 shadow-sm transition-all hover:border-slate-200 hover:shadow-md">
                    ...
                    <!-- Title -->
                    <h3 class="mb-1 text-base font-semibold leading-snug text-slate-800 ${task.status == "complete"
